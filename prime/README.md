...
1. Look at [the template source](https://github.com/techie-joe/prime/blob/master/_layouts/prime.html) to determine the name of the variable. It will be in the form of:
